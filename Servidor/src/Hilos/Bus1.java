...
public class Bus1 extends Thread{
    ...
    public void run(){
        ...
        while (counter<3){
            try {
            File file = new File("Buses/Coordenadas/Bus1Fluid.txt");
            ...
            while (entry.hasNext()){
                ...
                GUI.bus1.setLocation(posX-15, posY-15);
                sleep(16); //Original: 16 //Rápida: 6
                if (sending==true){
                    enviarCoordenadasBus1();
                }
            }
        ...
        GUI.iniciarDomingo.setEnabled(true);
    }
    
    
    
    public void enviarCoordenadasBus1() throws IOException{
        
        String parada = "Próxima Parada - Bus 1: ";
    ...
    public void declareStopped() throws IOException{
        GUI.escrituraDatos.writeUTF("Ejecución Finalizada.");
        GUI.escrituraDatos.flush();
    }
