...
public class Bus6 extends Thread{
    ...
    public void run(){
        ...
        while (counter<3){
            try {
            File file = new File("Buses/Coordenadas/Bus6Fluid.txt");
            ...
            while (entry.hasNext()){
                ...
                GUI.bus6.setLocation(posX-15, posY-15);
                sleep(16); //Original: 16 //Rápida: 6
                if (sending==true){
                    enviarCoordenadasBus6();
                }
            }
            counter++;
    ...
    public void enviarCoordenadasBus6() throws IOException{
        
        String parada = "Próxima Parada - Bus 6: ";
