...
public class Bus10 extends Thread{
    ...
    public void run(){
        ...
        while (counter<3){
            try {
            File file = new File("Buses/Coordenadas/Bus10Fluid.txt");
            ...
            while (entry.hasNext()){
                ...
                GUI.bus10.setLocation(posX-15, posY-15);
                sleep(16); //Original: 16 //Rápida: 6
                if (sending==true){
                    enviarCoordenadasBus10();
                }
            }
            counter++;
    ...
    public void enviarCoordenadasBus10() throws IOException{
        
        String parada = "Próxima Parada - Bus 10: ";
