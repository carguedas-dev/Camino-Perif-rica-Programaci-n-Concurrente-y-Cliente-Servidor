...
public class Bus8 extends Thread{
    ...
    public void run(){
        ...
        while (counter<3){
            try {
            File file = new File("Buses/Coordenadas/Bus8Fluid.txt");
            ...
            while (entry.hasNext()){
                ...
                GUI.bus8.setLocation(posX-15, posY-15);
                sleep(16); //Original: 16 //Rápida: 6
                if (sending==true){
                    enviarCoordenadasBus8();
                }
            }
            counter++;
    ...
    public void enviarCoordenadasBus8() throws IOException{
        
        String parada = "Próxima Parada - Bus 8: ";
