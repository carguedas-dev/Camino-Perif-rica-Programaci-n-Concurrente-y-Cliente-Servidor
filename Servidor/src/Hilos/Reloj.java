...
public class Reloj extends Thread {
    ...
    int days= 0, hours=4, minutes=29, seconds=0; 
    ...
    public void setTime(){
        while(true){
            ...
            GUI.reloj.setFont(new Font("Verdana", Font.BOLD, 36));
            if (hours>=5){
            ...
            GUI.reloj.setText(forGUI);;
            if (forGUI.equals("Martes | 00:00")){
                GUI.reloj.setText(forGUI);
                break;
            }
            if (forGUI.equals("Lunes | 05:00")){
            ...
            //Refresh rate
            try {
                sleep(192); //Original: 192, //Ejecución rápida: (long) 74.5
