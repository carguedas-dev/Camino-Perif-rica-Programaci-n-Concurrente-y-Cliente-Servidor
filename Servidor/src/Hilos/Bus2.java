...
public class Bus2 extends Thread{
    ...
    public void run(){
        ...
        while (counter<3){
            try {
            File file = new File("Buses/Coordenadas/Bus2Fluid.txt");
            ...
            while (entry.hasNext()){
                ...
                if (skip==true){
                    ...
                    if (Bus1.array[0].equals(stop)){
                        System.out.println("Concurrencia resuelta -- Bus 2 retornado a su lugar.");
                        skip = false;
                        sendDet = false;
                        GUI.bus2.setLocation(posX-15, posY-15);
                    } 
    ...
    public void sendDetenido() throws IOException{
        GUI.escrituraDatos.writeUTF("Bus 2 - Detenido.");
        GUI.escrituraDatos.flush();
    }
    
    public void enviarCoordenadasBus2() throws IOException{
        
        String parada = "Próxima Parada - Bus 2: ";
